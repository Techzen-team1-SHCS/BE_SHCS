...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('hotel_chat_threads', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('hm_id')->references('id')->on('users')->onDelete('set null');
    ...
    {
        Schema::dropIfExists('hotel_chat_threads');
    }
};
